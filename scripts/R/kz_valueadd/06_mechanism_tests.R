...
cat("\nPublic record (triangulation): post-2022 KZ launched/announced Chinese-brand SKD plants",
    ...
    "\ncapacity evidence is press/announcement triangulation, not deal data. A symmetric",
    "\nWebSearch-based announcement search on the same 2022-2025 window, for electrical-machinery,",
    "\ncomponent and instrument capacity in Kazakhstan, was conducted separately (JIE round-1",
    "\nreview, Referee B Concern 6; not reconstructed in this script, which only triangulates from",
    "\nthe deal database -- see corridor.tex Section 7/9 for the search and its result). It turned",
    "\nup no comparable named capacity project, and is treated in the paper as a weaker check than",
    "\nthis auto-sector triangulation, not an equally thorough symmetric search: the auto-sector",
    "\nevidence draws on more extensive public reporting on that sector specifically. Much of the",
    "\nauto capacity also predates 2022.\n")
