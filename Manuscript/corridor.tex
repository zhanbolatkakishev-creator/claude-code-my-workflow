...
performs---is about 49\%. A wholesale-plus-freight margin sits in the lower part of that range. The freight-and-insurance
wedge between an f.o.b.\ and a c.i.f.\ price is conventionally a few per cent (the c.i.f./f.o.b.\
factor applied in trade statistics is about 1.06); recorded c.i.f./f.o.b.\ margins for
former-Soviet economies are too noisy to use directly---for several the recorded f.o.b.\ figure
exceeds the c.i.f.\ one \citep{arvis2010landlocked}---so we do not lean on them. Adding a
wholesale distributive margin of a few points to a single-digit freight wedge gives the lower
half of the Bureau of National Statistics bracket. We use \textbf{6--14\%} and treat it as a
