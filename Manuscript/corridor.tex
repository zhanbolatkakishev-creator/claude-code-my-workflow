...
on goods that became harder to source directly are expected, and the value-weighted aggregate wedge is
...
about \$15m per month in 2023-H1 to about \$9m in 2023-H2. This coincided with trade-monitoring
measures tightening through 2023: the EU's eleventh sanctions package (Council Regulation (EU)
2023/1214 of 23 June 2023) introduced a transit-monitoring provision. A firm observing this in
real time saw the flow already receding within eighteen months---low $\rho$, and a $\sigma$
dominated by policy risk.
...
\midrule
Shock persistence $\rho$ (structural reallocation vs.\ event-driven) & irreversibility & low (transitory) & high \\
Uncertainty $\sigma$ / policy risk & irreversibility & high & low \\
...
timing---and share Kazakhstan's value on every moderator: the shock is event-driven and
transitory, policy risk is high, and the customs union removes the need to transform. Two features
...
domestic value-added a condition of capturing the flow: value-added or local-content
thresholds for goods re-exported onward in the priority sectors, procurement and
investment-incentive rules that reward domestic processing, and use of the customs-union
position to attract assembly rather than only transit. This is the sharpest lever and the
hardest, because it trades some current throughput for the chance of durable capacity.
...
a listing on the Astana exchange) rather than the buy-back that dominates today, and to build
the domestic private-equity exit market alongside it.
...
findings. Value-added-tax rebate and export-processing rules currently favour finished-goods
export over component export plus assembly in Kazakhstan, tilting firms toward shipping the
completed article rather than locating a stage of production on the route. Approval friction
...
the block being upstream of finance, though its mandate and its cross-border-compliance
exposure cloud the comparison. The institutional gate then explains the missed alternative: the
durable opportunities the shock reveals, in logistics and machinery, are left to slow, directed
state capital. Armenia and
...
response does occur, even without a deep capital market. The static value Kazakhstan misses
