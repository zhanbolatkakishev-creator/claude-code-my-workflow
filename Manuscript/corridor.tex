...
timing---neither country having a ``New Kazakhstan'' reform. The direction is also
...
inbound of about \$3.2bn, it is one sixth. The inbound leg is the more weakly identified of
...
multiples---a median near four in the highest priority tiers,\footnote{The priority list is
...
instruments and components.} on about half the
...
paper the expansion is consistent with the framework rather than against it, for three
reasons. First, part of the crossover is the denominator: mining and oil contracted, so a
rising manufacturing \emph{share} overstates the real divergence. Second, the growth is
concentrated in passenger vehicles and assembly (machinery output up about 22\%, on
full-cycle plants with roughly 190{,}000 units of announced capacity) and in domestic-demand
import substitution (fabricated metals, chemicals, pharmaceuticals)---not in the re-export
lines of this study, where no capacity was added. Third, the mechanism is the one the
...
it did not. The contrast is the paper's point, not a challenge to it.
...
alone. Fourth, the deal databases capture \emph{transacted} investment---M\&A and private
