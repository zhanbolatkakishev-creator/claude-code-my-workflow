...
(Bai--Perron, 95\% CI 2022m4--2022m6; sup-$F$ of 561 under a homoskedastic covariance, against
...
Newey--West correction the sup-$F$ falls to 326 but the 95\% CI is unchanged (2022m4--2022m6),
...
clean percentage-change reading across cells; the two specifications agree on sign and
significance but not on implied magnitude (the asinh point estimate corresponds to a level
effect several times larger than PPML's $3.5\times$), which is a reason we lean on the sign and
