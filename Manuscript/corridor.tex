...
domestic investment. After February 2022, part of Russia's disrupted trade was reallocated
through neighbouring economies. For Kazakhstan, we measure this shock, estimate what it
retains, and ask whether it induced investment. Exports to Russia in 29 product lines rise
roughly tenfold from May 2022; since the difference-in-differences is not separable from its
own selection rule, identification rests on break dates, levels, and a neighbour comparison.
Propagating a wholesale-and-freight margin (6--14\%) through the input--output table implies
domestic value added of 5--11 cents per rerouted dollar, against three-quarters for a produced
dollar. Across three deal databases we find no investment response. We read the null through
three gates --- market access, irreversibility, and capital-market institutions --- and show
the market-access gate is open and the least capital-constrained investor did not build.
Kazakhstan is a corridor, not a factory.

\medskip
\noindent\textbf{Keywords:} trade reorientation; investment under uncertainty; irreversibility;
value added; institutional voids; Kazakhstan.
\quad\textbf{JEL:} F14, F15, O14, O33, E22, P33.
\end{abstract}
...
During the preparation of this work the author used Claude (Anthropic) in order to draft and
edit prose, help write and debug the analysis code, and assist with structured internal review
of the manuscript. After using this tool, the author reviewed and edited the content as needed
and takes full responsibility for the content of the publication. All data choices, analytical
decisions, results and interpretations are the author's own.
