...
- ~~`/capture-environment` (renv) + assemble the replication package.~~ **Done (2026-09-02).**
  ...
  and `00_run_all.R`, and verified end-to-end; MIT license in place). The Mendeley Data deposit
  record (the repository the JIE Guide for Authors specifies) is drafted paste-ready at
  `replication_package/DEPOSIT.md`; remaining before upload is
